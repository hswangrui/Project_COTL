...
public class AmplifyColorBase : MonoBehaviour
{
	...
	public Texture LutHighlightTexture=null;

	public Texture LutHighlightBlendTexture=null;
	...
	private void OnRenderImage( RenderTexture source, RenderTexture destination )
	{
		...
		ValidateLutDimensions(LutHighlightTexture);
		ValidateLutDimensions(LutHighlightBlendTexture);

		bool skip = ( LutTexture == null && LutBlendTexture == null && volumesLutBlendTexture == null &&  LutHighlightTexture == null && LutHighlightBlendTexture == null);

		Texture texture = ((LutTexture == null) ? defaultLut : LutTexture);
		Texture lutBlendTexture = LutBlendTexture;

		Texture texture2 = ((LutHighlightTexture == null) ? defaultLut : LutHighlightTexture);
		Texture lutHighlightBlendTexture = LutHighlightBlendTexture;
