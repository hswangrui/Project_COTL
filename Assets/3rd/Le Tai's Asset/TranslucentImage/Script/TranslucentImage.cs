...
public partial class TranslucentImage : Image, IMeshModifier
{
    ...
    void LateUpdate()
    {
        ...
        {
           Debug.LogWarning("Translucent Image require a material using \"UI/TranslucentImage\" shader");
        }
    ...
    {
          if(!materialForRendering.HasProperty(propId))
            {

                Debug.LogWarning("Material cannot found  property !");
                return;
            }
