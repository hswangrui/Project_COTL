...
public class StencilLighting_DecalSprite_Fill : BaseMonoBehaviour
{
	...
	private void SetScale()
	{
		...
		if (!Mathf.Approximately(base.gameObject.transform.localScale.z, num))
		{
			base.gameObject.transform.localScale = new Vector3(base.gameObject.transform.localScale.x, base.gameObject.transform.localScale.y, num);
		}
	}
