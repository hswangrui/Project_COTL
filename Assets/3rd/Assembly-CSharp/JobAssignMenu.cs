...
public class JobAssignMenu : BaseMonoBehaviour
{
	...
	{
		WorshipperInfoManager worshipperInfoManagerByJobID = WorshipperInfoManager.GetWorshipperInfoManagerByJobID(workPlace.ID);
		if (worshipperInfoManagerByJobID != null)
		{
			...
			component.Name.text = worshipperInfoManagerByJobID.v_i.Name;
			component.Icon.color = new Color(worshipperInfoManagerByJobID.v_i.color_r, worshipperInfoManagerByJobID.v_i.color_g, worshipperInfoManagerByJobID.v_i.color_b);
		}
	}
	...
	{
		Worshipper.GetWorshipperByJobID(workPlace.ID);
		Worshipper.ClearJob(workPlace.ID, 0);
	}
}
