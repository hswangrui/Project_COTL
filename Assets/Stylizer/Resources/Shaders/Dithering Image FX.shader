...
Shader "Beffio/Image Effects/Dithering Image Effect" 
{
	Properties 
	{
		...
		_PaletteTex2 ("_PaletteTex2", 2D) = "black" {}

		_PaletteLerp ("Palette Lerp", float) = 0
		...
		Pass 
		{
			CGPROGRAM
				...
				//	return fixed4(GetDitherColor(c.rgb, _PatternTex, _PaletteTex,_PaletteHeight, i.ditherPos, _PaletteColorCount, _PatternScale), c.a);
					return fixed4(GetDitherColor(c.rgb, _PatternTex, _PaletteTex,_PaletteTex2,_PaletteLerp,_PaletteHeight, i.ditherPos, _PaletteColorCount, _PatternScale), c.a);
				}
			ENDCG
		}
	}
