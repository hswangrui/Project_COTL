Shader "COTL/FX_MegaSlash_FlameWall" {
	Properties {
		...
		[Separator] [Header(Vertex Deform)] _DeformHeight ("Influence", Range(0, 1)) = 1
		...
		[Separator] [Header(Blending)] [Enum(UnityEngine.Rendering.BlendOp)] _BlendOp ("Blend Operation", Float) = 0
