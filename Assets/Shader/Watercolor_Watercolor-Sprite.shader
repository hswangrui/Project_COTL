Shader "Watercolor/Watercolor-Sprite" {
	Properties {
		...
		[Toggle] _MaskMainTex ("MaskMainTex", Float) = 1
		[HDR] _TintCOlor ("TintCOlor", Vector) = (1,1,1,1)
		_PlayerDistanceClamp ("PlayerDistanceClamp", Float) = 0.33
		[Header(Cull Mode)] [IntRange] [Enum(Off,0,Front,1,Back,2)] _CullMode ("CullMode", Float) = 0
