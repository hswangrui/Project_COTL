Shader "UberShader_DitherBlend" {
	Properties {
		...
		[Separator] [Header(DepthFade)] _DepthThreshold ("Depth Vignette - Threshold", Range(0, 1)) = 0.3
		_DepthSmoothness ("Depth Vignette - Smoothness", Range(0.01, 1)) = 0.2
		[Separator] [Header(Alpha CutOff)] _Cutoff ("Alpha Cutoff", Range(0, 1)) = 0.5
