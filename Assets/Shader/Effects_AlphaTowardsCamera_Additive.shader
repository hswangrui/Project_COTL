Shader "Effects/AlphaTowardsCamera_Additive" {
	Properties {
		...
		_MaxAlphaClamp ("MaxAlphaClamp", Range(0, 1)) = 0.5
		[HDR] _LightColor ("LightColor", Vector) = (0,0,0,0)
		_UseTimeOfDayColor ("UseTimeOfDayColor", Range(0, 1)) = 0
